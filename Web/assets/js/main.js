...
$(document).ready(function() {
    ...
    async function predict(imageData) {
        ...
        if(probaWorried > probaNotWorried) {
            ...
            $("#worried-res-text").text("Shown by the decreasing height of the humps on the m’s. We predicted that this person doesn't tends to worry about what strangers might think about him/her")
